...
extension DummyModel {
    ...
    static var tLikeARollingStone: String {
        "Like A Rolling Stone"
    }

    static var tTombstoneBlues: String {
        "Tombstone Blues"
    }

    static var tItTakesALotToLaugh: String {
        "It Takes a Lot To Laugh, It Takes a Train to Cry"
    }

    static var tFromABuick6: String {
        "From a Buick 6"
    }

    static var tBalladOfAThinMan: String {
        "Ballad of a Thin Man"
    }

    static var tQueenJaneApproximately: String {
        "Queen Jane Approximately"
    }

    static var tHighway61Revisited: String {
        "Highway 61 Revisited"
    }

    static var tJustLikeTomThumbsBlues: String {
